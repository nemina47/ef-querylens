...
namespace SamplePostgresApp.Application.Customers;

public sealed class CustomerReadService
{
    private readonly IPostgresAppDbContext _dbContext;

    public CustomerReadService(IPostgresAppDbContext dbContext)
    {
